namespace VehicleShop.Entities.Cars
{
    ...
    public abstract class CarIc : Car , IInternalCombustion
    {
        ...
        public CarIc(string carMaker, Brand brand, double maxSpeed, double acceleration, DateTime originDate, decimal price, string colour) : base(carMaker, brand, maxSpeed, acceleration, originDate, price, colour)
        {
        }
    }
}